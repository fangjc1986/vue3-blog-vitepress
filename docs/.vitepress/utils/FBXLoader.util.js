...
(function () {
  ...
  class FBXTreeParser {
    ...
    createLight(relationships) {
      ...
      if (lightAttribute === undefined) {
        ...
        let intensity =
          lightAttribute.Intensity === undefined ? 1 : lightAttribute.Intensity.value / 100; // light disabled
  ...
  function generateTransform(transformData) {
    ...
    if (transformData.rotationPivot)
      lRotationPivotM.setPosition(tempVec.fromArray(transformData.rotationPivot)); // parent transform
